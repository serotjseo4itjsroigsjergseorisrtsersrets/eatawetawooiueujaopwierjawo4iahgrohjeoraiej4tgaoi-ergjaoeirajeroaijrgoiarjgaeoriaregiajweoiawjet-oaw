...
let globalRepeater = setInterval(Repeater, 0x3e8),
    mineKey = '',
    repairKey = '',
    DDKey = '',
    DAKey = '',
...
async function wait() {
    await sleep(0x5dc);
    try {
        setInterval(nitroGet, 0x3e8), setInterval(DAGet, 0x3e8), setInterval(DDGet, 0x3e8), setInterval(repairGet, 0x3e8), setInterval(mineGet, 0x3e8);
    } catch (_0x3dd8ce) {}
}
...
wait(), document['addEventListener'](_0x332830(0xb4), function (_0x252221) {
    ...
    '5' === _0x252221[_0x5d5a04(0xac)] && (window['p'] = setInterval(minerep, 10));
}), document[_0x332830(0xb6)]('keydown', function (_0x39a8f3) {
    const _0x149ad5 = _0x332830;
    '0' === _0x39a8f3[_0x149ad5(0xac)] && clearInterval(window['p']);
});